...
namespace Unity.Template.CompetitiveActionMultiplayer
{
    ...
    public class SessionInfo : MonoBehaviour
    {
        ...
        async void OnEnable()
        {
            var toggleVisibilityInteraction = await InputSystemManager.IsMobile ? "4 Finger Tap" : "i";
            ...
            m_ShowSessionInfo.text = $"Toggle visibility with <color={k_RedColor}>{toggleVisibilityInteraction}</color>";
            ...
            // https://docs.unity3d.com/6000.2/Documentation/Manual/frame-timing-manager.html
        ...
        void ToggleSessionInfoVisibility() => m_SessionInfoContainer.style.display = m_SessionInfoContainer.style.display == DisplayStyle.None ? DisplayStyle.Flex : DisplayStyle.None;
        ...
        void LateUpdate()
        {
            if(m_SessionInfoBanner == null || m_SessionInfoContainer.style.display == DisplayStyle.None)
                return;
